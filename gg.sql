...
SELECT * FROM AUTORES WHERE SEUDONIMO IS NULL ; -- ESTAMOS CONSULTANDO A LOS AUTORES QUE NO TIENE UN SEUDONIMO ES DECIR QUE SU SEUDONIMO SEA NULL

SELECT * FROM   AUTORES WHERE SEUDONIMO IS NOT NULL; -- ESTAMOS CONSULTANDO A LOS AUTORES QUE SI CUENTEN CON UN SEUDONIMO

SELECT * FROM AUTORES WHERE SEUDONIMO <=> NULL; -- OTRA FORMA DE

/* HACER CONSULTA DE REGISTRO MEDIANTE RANGOS */

SELECT TITULO FROM LIBROS WHERE FECHA_PUBLICACION BETWEEN '1892-01-03' AND '1975-01-01'; -- TYAMBIEN PODEMOS HACER CONSULTAS NO SOLO POR RANGO DE FECHA

/* HACER CONSULTA DE REGISTROS UNICOS */

SELECT  DISTINCT TITULO FROM LIBROS; -- EN NUESTRA BASE DE DATOS HAY UN TITULO REPETIDO QUE PERTENCE A AUTORES DIFERENTES Y AL MOMENTO DE NOSOTROS CONSULTAR LOS TITULOS NOS SALDRA REPETIDO
...
SHOW DATABASES;
SELECT *
FROM AUTORES WHERE SEUDONIMO IS NOT NULL;
